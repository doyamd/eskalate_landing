...
const WhyScreen = () => {
  return (
    <div className='flex flex-col gap-[40px]  items-center mt-10 lg:mt-32 w-full bg-blue-50 py-[80px]'>
        <h1 className=' text-center font-medium text-3xl lg:text-4xl'>Why are the best African developers at Eskalate?</h1>
        <div className='grid grid-cols-1 md:grid-cols-2 gap-2 lg:gap-10 my-2 h-full justify-between px-0 xl:px-[264px]'>
            <div className='felx flex-col'>
                <div className='flex items-center p-5 gap-4'>
                    ...
                    <div>
                        <p className='text-lg text-[#2195F3] font-bold'>Rigorous Training</p>
                ...
                <div className='flex items-center p-5 gap-4'>
                    ...
                    <div>
                    <p className='text-lg text-[#2195F3] font-bold'>Problem-solving Expertise</p>
                ...
                <div className='flex items-center p-5 gap-4'>
                    ...
                    <div>
                    <p className='text-lg text-[#2195F3] font-bold'>Strong Communication</p>
                ...
                <div className='flex items-center p-5 gap-4'>
                    ...
                    <div>
                    <p className='text-lg text-[#2195F3] font-bold'>Hands-on Experience</p>
