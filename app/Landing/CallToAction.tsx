...
const CallToAction = () => {
  return (
    <div className='h-[400px] md:mx-0 lg:mx-36 my-20 shadow-lg relative lg:rounded-[40px] overflow-hidden' style={{ boxShadow: '0px 5px 15px 0px rgba(0, 0, 0, 0.1)' }}>
      <div
      ...
      >
        ...
        <div className='text-md flex flex-col justify-center items-center text-white relative z-10'>
          <p className='m-2 text-center font-bold text-3xl lg:text-4xl'>Diverse Perspectives, Global impact </p>
          <p className='m-2 text-center text-[15px] md:text-[20px] w-985%]'>
          ...
          <button className='px-3 py-2 m-5 font-semibold text-[16px] rounded-[4px] bg-white text-[#2195F3]'>Schedule a call</button>
        </div>
      </div>
    </div>
  );
